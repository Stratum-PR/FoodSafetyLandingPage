...
const EN = {
  ...
  navCta: "Take the self-check", menuOpen: "Open menu", menuClose: "Close menu", navPricing: "Pricing",
  ...
  howBody: "13 questions cover supplier registration, food safety, traceability and insurance. At the end you get your Walmart passport with your score and your to-do list, each item with its official source.",
  ...
  footAbout: "About us", footContact: "Contact", footPlan: "MVP plan ↗", footPricing: "Pricing",
  ...
  // Pricing page (precios.html)
  prEyebrow: "Pricing", prTitle: "One price per site. Unlimited users.",
  prLead: "Supplier and document control, AI certificate reading and records ready for FSMA and SQF. Your whole team gets in at no extra cost: quality, purchasing and warehouse.",
  prPilot: "<strong>We're in the pilot phase.</strong> Request access and we'll contact you to activate your account. Nothing is charged today.",
  prBillingLabel: "Billing frequency", prMonthly: "Monthly", prAnnual: "Annual", prSave: "2 months free",
  prPerMonth: "/mo", prFrom: "from", prCta: "Request access", prPopular: "For certified plants",
  t1For: "For producers getting ready to sell to Walmart or for their first GFSI audit.",
  t1L1: "Up to 20 active suppliers", t1L2: "1 site · unlimited users", t1L3: "200 AI pages a month + 2,000 for your initial upload",
  t1F1: "Suppliers and documents with an editable catalog", t1F2: "Expirations and a daily email digest",
  t1F3: "Links for your suppliers to upload documents, with reminders", t1F4: "AI certificate reading",
  t1F5: "Bulk upload from a ZIP", t1F6: "Change history and full export", t1F7: "Email support in Spanish and English",
  t2For: "For SQF-certified manufacturers that need a complete supplier program.",
  t2L1: "Up to 100 active suppliers", t2L2: "1 site (+$199/mo per additional site) · unlimited users", t2L3: "600 AI pages a month + 7,500 for your initial upload",
  t2Plus: "Everything in Esencial, plus:",
  t2F1: "Manufacturer and distributor for every ingredient", t2F2: "Risk-based supplier verification, per FSMA and SQF",
  t2F3: "Sample evaluation and an online supplier questionnaire", t2F4: "Nonconformities, alerts and a yearly performance review",
  t2F5: "Purchasing and warehouse roles", t2F6: "Priority support (next business day)",
  t3For: "For manufacturers with several sites, and for distributors.",
  t3L1: "Unlimited suppliers", t3L2: "3 sites (+$149/mo for each additional) · unlimited users", t3L3: "1,500 AI pages a month + 20,000 for your initial upload",
  t3Plus: "Everything in Profesional, plus:", t3F1: "Supplier view across sites", t3F2: "Implementation manager", t3F3: "99.5% uptime target",
  prNote: "Prices in US dollars, per site. An active supplier is one you work with today; inactive ones don't count. 30-day trial, no setup fee.",
  cmpTitle: "Compare the plans", cmpFeature: "Feature",
  c1: "Suppliers and documents, editable catalog", c2: "Expirations and daily digest", c3: "Supplier upload links, with reminders",
  c4: "AI certificate reading", c5: "Bulk upload from a ZIP, with review", c6: "Change history, archive and full export",
  c7: "Manufacturer and distributor per ingredient", c8: "Risk-based verification (FSMA and SQF)", c9: "Sample evaluation and online questionnaire",
  c10: "Nonconformities and performance review", c11: "Purchasing and warehouse roles", c12: "Multiple sites", c12b: "+$199/mo each", c12c: "3 included",
  c13: "Coming soon: corrective actions (CAPA) and daily inspections", c13a: "Basic CAPA", c14: "Coming soon: StratAI assistant", c14a: "Optional", c14b: "With credits",
  a1T: "More AI pages", a1B: "$29 per 1,000 additional pages.",
  a2T: "Assisted upload", a2B: "We upload and review your documents: $750 up to 40 suppliers, $1,500 up to 100.",
  a3T: "Consulting", a3B: "SQF practitioner/PCQI support, Walmart readiness and audit prep, by the hour.",
  roiEyebrow: "Calculator", roiTitle: "What does handling supplier documents cost you today?",
  roiLead: "Enter your numbers. It's an estimate: adjust the expected savings to your reality.",
  rSup: "Active suppliers", rDoc: "Hours a month requesting, chasing, filing and checking documents",
  rAud: "Hours a month preparing audits and answering customer requests", rRate: "Hourly cost of that person (salary and benefits, $)",
  rCons: "Monthly consulting spend you could reduce ($)", rSave: "Time you expect to save",
  rPlan: "Recommended plan", rHours: "Hours saved a month", rValue: "Value of that time and consulting", rCost: "Plan cost",
  rNet: "Difference per month", rFoot: "Doesn't include what costs the most: a failed audit, a suspension as a Walmart supplier or a product recall.",
  rCta: "Request access to this plan",
  faqTitle: "Frequently asked questions",
  q1: "Is anything charged when I request access?", q1a: "No. We're in the pilot phase: we contact you, talk about your operation and activate a 30-day trial. You only pay if you decide to continue.",
  q2: "What's an active supplier?", q2a: "A manufacturer or distributor you work with today. Inactive or rejected suppliers stay in your history but don't count toward the limit.",
  q3: "What are AI pages?", q3a: "Each page of a document the AI reads to propose type, supplier and dates. Your team always confirms before accepting. Each plan includes monthly pages and a pack for your initial upload.",
  q4: "Can I change plans?", q4a: "Yes, anytime. If you grow in suppliers or sites, you move to the next plan; if you shrink, you move down at renewal.",
  q5: "Is my data mine?", q5a: "Yes. You can download everything (documents, records and history) anytime. If you cancel, your data stays read-only for 90 days and is then deleted.",
  reqTitle: "Request access", reqLead: "We're activating the first accounts. Leave your details and we'll contact you within 1–2 business days. Nothing is charged today.",
  reqTier: "Plan", reqBilling: "Billing", reqUnsure: "Not sure", reqSup: "Active suppliers", reqPick: "Select",
  reqMsg: "What would you like to solve first? (optional)", reqSend: "Send request",
  reqPrivacy: "We'll only use this to contact you about access. See the <a href=\"privacidad.html\">Privacy Policy</a>.",
};
...
const MSG = {
  es: {
    ...
    reqOk: "¡Recibido! Te contactaremos en 1 a 2 días laborables.",
    reqFail: "No pudimos enviar tu solicitud. Inténtalo otra vez o escríbenos por Contacto.",
  ...
  en: {
    ...
    reqOk: "Received! We'll contact you within 1–2 business days.",
    reqFail: "We couldn't send your request. Try again or reach us through Contact.",
